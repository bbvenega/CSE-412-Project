...
-- For table "user"
ALTER TABLE "Users" ADD PRIMARY KEY (U_USER_ID);
...
-- For table admin
ALTER TABLE "Admins" ADD PRIMARY KEY (A_ADMIN_ID);

COMMIT WORK;
---------------------------------------------------------------

----------------------- Admin IS A User -----------------------
ALTER TABLE "Admins" ADD FOREIGN KEY (A_ADMIN_ID) references "Users" (U_USER_ID);

COMMIT WORK;
---------------------------------------------------------------

--------- User -> Watchlist Relationship (One to Many) ---------
ALTER TABLE WATCHLIST ADD FOREIGN KEY (W_USER_ID) references "Users" (U_USER_ID);
